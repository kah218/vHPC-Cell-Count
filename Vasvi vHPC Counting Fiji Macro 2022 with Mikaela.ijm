dir1 = getDirectory("/Users/kah218/Desktop/Test-Vasvi");	 /* Selects an input directory. Note the double slashes. */
...
run("Remove Outliers...", "radius=10 threshold=150 which=Bright");
...
run("Subtract Background...", "rolling=6000");

setAutoThreshold("Default dark");
//run("Threshold...");		//commented before
call("ij.plugin.frame.ThresholdAdjuster.setMode", "B&W");
setThreshold(13, 104, "raw");
//setThreshold(13, 104);
